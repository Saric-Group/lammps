...
#ifdef PAIR_CLASS
// clang-format off
PairStyle(cosine/squared/surface, PairCosineSquaredSurface);
// clang-format on
#else
...
class PairCosineSquaredSurface : public Pair {
 public:
  PairCosineSquaredSurface(class LAMMPS *);
  ~PairCosineSquaredSurface() override;
